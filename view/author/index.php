<?php
    ...
    $author = new Author();
    $records = $author->mightyGetRecord();
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        $author->setFields($_POST);
        $author->mightyDelete();
    }
?>
           ...
           <div class="card card-block card-stretch card-height">
                <div class="card-header d-flex justify-content-between">
                    <div class="header-title">
                        <h4 class="card-title mb-0">Author List</h4>
                    </div>
                    <a href="?page=author_create" class="btn btn-primary">Add New</a>
                </div>
                <div class="card-body">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="mm-avatar col-md-2">
                                                        <img class="avatar-40 rounded" src="../upload/author/<?= $data['image'] ?>" alt="#img" data-original-title="" title="">
                                                    </div>    
                                                </td> 
                                                <td><?= $data['name'] ?></td>
                                                ...
                                                <td>
                                                    <div class="d-flex align-items-center list-action">
                                                        <a class="badge bg-primary-light mr-2" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit" href="?page=author_create&id=<?= $data['id'] ?>" ><i class="las la-edit"></i></a>
