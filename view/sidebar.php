        ...
        <nav class="mm-sidebar-menu">
            <ul id="mm-sidebar-toggle" class="side-menu">
                ...
                <li class="<?= $active === 'customer' ? 'active' : '' ?>">
                    ...
                    <ul id="customer" class="submenu collapse" data-parent="#mm-sidebar-toggle">
                        <li class="<?= $active_submenu === 'customer_list' ? 'active' : '' ?>">
                            <a href="../view/index.php?page=customer" class="svg-icon">
                                <i class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" id="mm-book-list" class="svg-icon" viewBox="0 0 24 24"
                                         stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
...
<!--                        <li class="--><?//= $active_submenu === 'customer_create' ? 'active' : '' ?><!--">-->
<!--                            <a href="../view/index.php?page=customer_create" class="svg-icon">-->
<!--                                <i class="">-->
<!--                                    <svg xmlns="http://www.w3.org/2000/svg"  id="mm-book-add" class="svg-icon" viewBox="0 0 24 24" stroke-width="2"-->
<!--                                         stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">-->
<!--                                        <path stroke="none" d="M0 0h24v24H0z" fill="none"/>-->
